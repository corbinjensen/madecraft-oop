...
/**
 * To make these tests pass, you will need to create a 
 ...
 * </code>
 * 
 * Create a constructor, and getters and setters for 
 * the member variables. If they’re done right, 
...
public class MinionTest {
    ...
    /* public static void main(String[] args) {
        Minion minion = new Minion("Stuart", 1, "yellow","");
